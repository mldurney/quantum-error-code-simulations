...
Lattice* chooseLattice(const char shape, const Hamiltonian& hamiltonian, const double temp, 
	const char mode);
std::string getOutFilename(const std::string& inFilename, const std::string& oldDir,
