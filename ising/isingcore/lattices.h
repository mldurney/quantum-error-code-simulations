...
class RectangularLattice : public Lattice {
   public:
    RectangularLattice(Hamiltonian h, double t, char m = 'r', int r = -1,
                       int c = -1);
...
class TriangularLattice : public Lattice {
   public:
    TriangularLattice(Hamiltonian h, double t, char m = 'r', int r = -1,
                      int c = -1);
    int getRows() const { return rows; }
    int getCols() const { return cols; }
    void printLattice(int empty = -1) { Lattice::printLattice(getCols()); }
